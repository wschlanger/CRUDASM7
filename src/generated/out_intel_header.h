...
enum
{
	...
	RULE_ixremarks = 0x30004,
	RULE_ixknown_item = 0x30005,
	RULE_ixset_item = 0x30006,
	RULE_ixgroup_def = 0x30007,
	RULE_ixinsn_arg_list = 0x30008,
	RULE_ixinsn_body = 0x30009,
	RULE_ixemu_body = 0x3000a,
	RULE_ixident_list = 0x3000b,
	RULE_ixinsn_arg = 0x3000c,
	RULE_ixmachine_code = 0x3000d,
	RULE_ixdis_body = 0x3000e,
	RULE_ixdis_stmt = 0x3000f,
	RULE_ixrhs_list = 0x30010,
	RULE_ixrhs = 0x30011,
	RULE_ixslash_code = 0x30012,
	RULE_ixmachine_arg_list = 0x30013,
	RULE_ixmachine_extra_list = 0x30014,
	RULE_ixmachine_extra_item = 0x30015,
	RULE_ixemu_stmt = 0x30016,
	RULE_ixrhs_prefix = 0x30017,
	RULE_ixrhs_terminal = 0x30018,
	RULE_ixbinary_op = 0x30019,
	RULE_ixsigned_cast = 0x3001a,
	RULE_ixalternates = 0x3001b,
	RULE__ixcount = 28
};
...
enum
{
	...
	KEYWORD_ixexcept_assert = 0x2001d,	// "except_assert"
	...
	KEYWORD_ixreturn = 0x2001e,	// "return"
	KEYWORD_ixset = 0x20009,	// "set"
	KEYWORD_ixsigned = 0x2001f,	// "signed"
	KEYWORD_ixsynopsis = 0x20013,	// "synopsis"
	KEYWORD_ixundefined = 0x2001c,	// "undefined"
	KEYWORD_ixunsigned = 0x20020,	// "unsigned"
